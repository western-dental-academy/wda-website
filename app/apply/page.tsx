...
export const metadata: Metadata = {
  title: "Apply",
  description:
    "Start your application to Western Dental Academy. Complete our short multi-step form and our admissions team will be in touch within one to two business days.",
};
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-20">
          ...
          <nav aria-label="Breadcrumb" className="mb-10">
            <ol className="flex items-center gap-2 text-xs font-semibold">
              ...
              <li style={{ color: "rgba(255,255,255,0.7)" }}>Apply</li>
            </ol>
          </nav>
          ...
          >
            Start Your{" "}
            <span style={{ color: "#4A9FD4" }}>Application.</span>
          </h1>
          ...
          >
            Complete the four-step form below and our admissions team will
            review your application and reach out within one to two business
            days.
          </p>
