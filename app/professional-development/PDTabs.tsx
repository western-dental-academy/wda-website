        ...
        <div className="flex flex-col flex-1 p-6 sm:p-8">
          ...
          {hasUpcoming ? (
            <>
              ...
              {offering.hasVirtualOption ? (
                <div className="flex gap-2">
                  <Link
                    href={`/register?offering=${encodeURIComponent(offering.title)}&dateId=${nextDate!._id}&delivery=in-person`}
                    className="flex-1 text-center inline-flex items-center justify-center gap-1.5 rounded-lg px-4 py-2.5 text-sm font-bold text-white transition-all duration-200 hover:scale-[1.02]"
                    style={{ backgroundColor: "#1E3560" }}
                  >
                    In-Person →
                  </Link>
                  <Link
                    href={`/register?offering=${encodeURIComponent(offering.title)}&dateId=${nextDate!._id}&delivery=virtual`}
                    className="flex-1 text-center inline-flex items-center justify-center gap-1.5 rounded-lg px-4 py-2.5 text-sm font-bold text-white transition-all duration-200 hover:scale-[1.02]"
