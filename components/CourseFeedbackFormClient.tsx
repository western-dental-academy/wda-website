...
export default function CourseFeedbackFormClient({ token, firstName, courseName }: Props) {
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm" style={{ color: 'rgba(43,48,58,0.65)' }}>
          How was your experience with <strong style={{ color: '#0D3B6E' }}>{courseName}</strong>?
        </p>
      </div>
      ...
      <label className="flex items-start gap-3 cursor-pointer">
        ...
        <span className="text-sm text-gray-600">
          I consent to Western Dental Academy sharing my feedback on our website and social media.
